## Visual Computing Slides -- representation
...
## Installation
 ...
 ```sh
 $ git clone https://github.com/VisualComputing/representation.git
 $ cd representation
...
3. Install dependencies (you must be already on the presentation folder, otherwise ```$ cd representation```)
